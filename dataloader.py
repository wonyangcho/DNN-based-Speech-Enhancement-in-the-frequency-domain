...
class Wave_Dataset(Dataset):
    def __init__(self, mode, type, snr):
        ...
        if mode == 'train':
            ...
            print('Load the data...')
            self.input_path = "/work/wycho/project/DNN-based-Speech-Enhancement-in-the-frequency-domain/kumc_lung_clinical_study/train.npy"
            self.input = np.load(self.input_path)
        elif mode == 'valid':
            self.mode = 'valid'
            print('<Validation dataset>')
            print('Load the data...')
            self.input_path =  "/work/wycho/project/DNN-based-Speech-Enhancement-in-the-frequency-domain/kumc_lung_clinical_study/val.npy"
            self.input = np.load(self.input_path)
            ...
            print('<Test dataset>')
            print('Load the data...')
            self.input_path =  "/work/wycho/project/DNN-based-Speech-Enhancement-in-the-frequency-domain/kumc_lung_clinical_study/test.npy"
